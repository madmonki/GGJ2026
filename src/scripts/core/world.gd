...
@onready var colorless_char_scene = preload("res://src/scenes/characters/colorless_char.tscn")
@onready var blue_char_scene = preload("res://src/scenes/characters/blue_char.tscn")
@onready var red_char_scene = preload("res://src/scenes/characters/red_char.tscn")
@onready var green_char_scene = preload("res://src/scenes/characters/green_char.tscn")
@onready var white_matte = preload("res://assets/materials/white_matte.tres")
@onready var gold_accent = preload("res://assets/materials/gold_accent.tres")

func _ready():
	# Start session timing
	GameEvents.start_session()
